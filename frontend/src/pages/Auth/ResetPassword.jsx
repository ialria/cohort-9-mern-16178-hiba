...
function ResetSuccess({ navigate }) {
  return (
...
function ResetPasswordForm({
  ...
  return (
    <div className="w-full md:w-1/2 bg-background min-h-screen py-10 px-6 md:px-10 lg:py-24 lg:px-24 flex flex-col items-center">
      ...
      <h2 className="text-text/80 font-semibold text-3xl">
        Set a new password
      </h2>
  ...
  function validateResetPassword(password, confirmPassword, passwordStrength) {
  const newErrors = {};
...
function ResetPassword() {
  ...
  async function handleSubmit(e) {
    ...
    const foundErrors = validateResetPassword(
      password,
      confirmPassword,
      passwordStrength
    );
    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      <div className="bg-primary w-full md:w-1/2 h-auto hidden md:block md:h-screen py-6 px-6 sm:px-8 md:px-10 lg:px-18 md:py-12 md:sticky top-0">
        ...
        <div className="max-w-md md:block mt-10 md:mt-23 mr-2 md:mr-2 lg:mr-12 lg:mt-24 xl:mt-32">
          <p className="text-background text-2xl md:text-3xl lg:text-4xl font-semibold">
      ...
      {resetSuccessful ? (
        <ResetSuccess navigate={navigate} />
      ) : (
        <ResetPasswordForm
          password={password}
          ...
          passwordCheckId={passwordCheckId}
